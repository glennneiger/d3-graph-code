...
// module
exports.push([module.i, "@media screen and (max-width: 767px) {\n  .top-bar .top-search {\n    margin: 10px 0; }\n  .top-bar .tab-content {\n    margin-top: 30px; }\n  #profile-main {\n    padding-bottom: 0; }\n    #profile-main .comment-tabs .nav-tabs {\n      text-align: center; }\n  #footer {\n    margin-top: 0px; }\n  #profile-main .comment-tabs .tab-content .tab-pane .main-tab .main-tab-inner-boxes .main-tab-inner-box .main-tab-inner-box-top-head h4 {\n    font-size: 14px;\n    width: 80%; }\n  .list-generator li {\n    margin-right: 20px; }\n  .top-my-account .btn {\n    width: auto;\n    height: auto; }\n  #profile-main .top-tabs .billing_contnet_main .billing_content .billing_grid .row .biling_left_side_col {\n    max-width: 100% !important;\n    flex: 0 0 100% !important; }\n  #profile-main .top-tabs .billing_contnet_main .billing_content .billing_grid .row .biling_right_side_col {\n    max-width: 100% !important;\n    flex: 0 0 100% !important; }\n  .top-tabs {\n    padding-top: 30px; }\n  .plan_uline {\n    margin-top: 12px; }\n  #profile-main .top-tabs .billing_contnet_main .billing_content .billing_grid .row .biling_left_side_col h4 {\n    margin-bottom: 15px !important; }\n  #profile-main .top-tabs .billing_contnet_main .billing_content .billing_grid .row .biling_right_side_col ul.visa_uline li img {\n    max-width: 20px !important;\n    margin-right: 5px !important; }\n  #profile-main .top-tabs .billing_contnet_main .billing_content .billing_grid .row .biling_right_side_col ul.visa_uline li {\n    font-size: 12px !important;\n    padding-right: 10px !important; }\n  .nova-header .nova-header-logo-container {\n    justify-content: center;\n    margin-bottom: 15px;\n    padding-left: 0;\n    width: 100%;\n    max-width: 100%;\n    flex: 0 auto; }\n    .nova-header .nova-header-logo-container .nova-header-logo {\n      width: auto;\n      max-width: 180px; }\n  .nova-header .col-12.col-sm-7 {\n    flex: 0 auto;\n    max-width: 100%; }\n    .nova-header .col-12.col-sm-7 .search-box-1 .btn {\n      height: 100%; }\n    .nova-header .col-12.col-sm-7 .search-box-1 input.form-control:focus {\n      box-shadow: none;\n      outline: none;\n      border-color: transparent; }\n  .nova-header .nova-account-header {\n    position: relative;\n    top: 0;\n    right: 0;\n    text-align: center;\n    flex: 0 auto;\n    max-width: 100%; }\n    .nova-header .nova-account-header .navbar-text {\n      float: none !important; }\n      .nova-header .nova-account-header .navbar-text .btn {\n        width: auto;\n        height: auto;\n        margin-top: 15px !important; } }\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./scripts/src/profile-overview/profile-overview.scss":
/*!*******************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./scripts/src/profile-overview/profile-overview.scss ***!
  \*******************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".programmer_pacemaker {\n  position: relative;\n  background: #fff; }\n  .programmer_pacemaker .programmer_header ul.program_uline li img {\n    max-width: 15px;\n    margin-right: 5px;\n    margin-top: -2px; }\n  .programmer_pacemaker .programmer_header ul.program_uline li.save_li a {\n    height: 36px;\n    display: inline-block;\n    padding: 0px 15px;\n    color: #fff;\n    border-radius: 4px;\n    background-color: #5bd6e5;\n    line-height: 36px; }\n  .programmer_pacemaker .programmer_header ul.program_uline li.share_li a {\n    border-radius: 4px;\n    border: solid 1px #a9b0b8;\n    height: 36px;\n    padding: 0px 15px;\n    line-height: 36px;\n    display: inline-block;\n    color: #939da7; }\n  .programmer_pacemaker .programmer_header h2 {\n    font-family: Roboto;\n    font-size: 24px;\n    color: #313e59;\n    line-height: 36px; }\n  .programmer_pacemaker .back_search {\n    position: relative;\n    padding-top: 40px; }\n  .programmer_pacemaker .programmer_header {\n    position: relative;\n    padding: 37px 0px 60px; }\n  .programmer_pacemaker .back_search a {\n    color: #939da7;\n    font-family: Roboto;\n    font-size: 14px; }\n    .programmer_pacemaker .back_search a i {\n      color: #5bd6e5;\n      margin-right: 5px; }\n\n.programmer_tabs .nav-tabs {\n  margin-top: -48px;\n  border-bottom: none; }\n  .programmer_tabs .nav-tabs a.active {\n    border: none;\n    border-bottom: 4px solid #5bd6e5;\n    opacity: 1;\n    background: transparent;\n    z-index: 9; }\n    .programmer_tabs .nav-tabs a.active:focus, .programmer_tabs .nav-tabs a.active:hover {\n      border: none;\n      border-bottom: 4px solid #5bd6e5;\n      opacity: 1;\n      background: transparent; }\n  .programmer_tabs .nav-tabs a {\n    border: 2px solid transparent;\n    border: none;\n    color: #313e59;\n    opacity: 0.65;\n    font-size: 14px;\n    padding: 12px 20px;\n    font-size: 14px; }\n\n.programmer_tabs .tab-content {\n  padding: 0;\n  border-left: none;\n  min-height: 1px; }\n  .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview {\n    padding: 50px 0px;\n    position: relative; }\n    .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row {\n      margin-left: -15px;\n      margin-right: -15px; }\n      .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid {\n        position: relative;\n        margin-bottom: 33px;\n        border-radius: 6px;\n        box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n        background-color: #ffffff;\n        min-height: 320px; }\n        .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_heading {\n          padding: 20px;\n          border-bottom: 1px solid #dfe2e5; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_heading h3 {\n            color: #5bd6e5;\n            font-family: Roboto;\n            font-size: 15px;\n            font-weight: 500;\n            text-transform: uppercase; }\n        .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content {\n          padding: 30px 24px;\n          position: relative; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content ul.over_uline li {\n            margin-bottom: 25px; }\n            .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content ul.over_uline li h5 {\n              font-family: Roboto;\n              font-size: 13px;\n              font-weight: normal;\n              color: #939da7;\n              line-height: 22px; }\n            .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content ul.over_uline li p {\n              font-family: Roboto;\n              font-size: 14px;\n              color: #313e59;\n              margin-bottom: 0;\n              word-break: break-all; }\n            .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content ul.over_uline li:last-child {\n              margin-bottom: 0px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content ul.over_uline.over_uline_m25 li {\n            margin-bottom: 25px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content img.telelectronics_logo {\n            margin-bottom: 20px;\n            max-width: 140px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content ul.over_uline li h4 {\n            font-family: Roboto;\n            font-size: 14px;\n            color: #6f788b;\n            line-height: 20px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content .over_uline .regultion_arrow_content {\n            padding-left: 0.5em; }\n            .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list {\n              padding-left: 10px;\n              border: 1px dotted #6f788b;\n              border-width: 0 0 2px 2px;\n              border-bottom: 15px; }\n              .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list p {\n                margin: 0;\n                background: white;\n                position: relative;\n                top: 8px;\n                padding-left: 5px;\n                line-height: 14px; }\n                .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list p a {\n                  color: #313e59; }\n              .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .row .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list ul {\n                border-left: 2px solid white;\n                margin-left: -12px;\n                border-top: 2px dotted #6f788b;\n                padding-left: 1.5em; }\n    .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .estimate_cost_div {\n      background-image: linear-gradient(to bottom, #4c5a78, #313e59);\n      border-radius: 6px;\n      box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n      height: 250px;\n      text-align: center;\n      padding: 45px 15px;\n      min-width: 270px; }\n      .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .estimate_cost_div h3 {\n        opacity: 0.7;\n        font-family: Roboto;\n        font-size: 15px;\n        font-weight: 500;\n        color: #fff;\n        text-transform: uppercase;\n        margin-bottom: 20px; }\n      .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .estimate_cost_div .price_cost {\n        font-family: Roboto;\n        font-size: 80px;\n        font-weight: 300;\n        color: #fff; }\n    .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main {\n      width: 100%;\n      border-radius: 6px;\n      box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n      background-color: #ffffff;\n      height: 250px; }\n      .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_time_div {\n        background-image: linear-gradient(to bottom, #7472ea, #5856d6);\n        border-radius: 6px;\n        box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n        height: 250px;\n        text-align: center;\n        padding: 45px 15px;\n        min-width: 270px;\n        float: left;\n        width: 35%;\n        max-width: 270px;\n        border-top-right-radius: 0;\n        border-bottom-right-radius: 0; }\n        .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_time_div h3 {\n          opacity: 0.7;\n          font-family: Roboto;\n          font-size: 15px;\n          font-weight: 500;\n          color: #fff;\n          text-transform: uppercase;\n          margin-bottom: 20px; }\n        .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_time_div .price_cost {\n          font-family: Roboto;\n          font-size: 80px;\n          font-weight: 300;\n          color: #fff;\n          line-height: 85px; }\n        .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_time_div p {\n          font-family: Roboto;\n          font-size: 20px;\n          color: #fff; }\n      .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_chart {\n        float: left;\n        width: 66%;\n        padding: 30px;\n        height: 250px; }\n        .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_chart .chart_tagline {\n          border-radius: 16px;\n          background-color: rgba(201, 206, 211, 0.23);\n          position: relative;\n          padding: 10px 15px;\n          margin-bottom: 25px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_chart .chart_tagline p {\n            margin-bottom: 0;\n            color: #313e59;\n            font-size: 14px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_chart .chart_tagline span.fast_tag {\n            font-family: Roboto;\n            font-size: 11px;\n            font-weight: bold;\n            text-transform: uppercase;\n            border-radius: 7.5px;\n            background-color: #8bcc31;\n            color: #fff;\n            padding: 6px 10px;\n            line-height: 9px;\n            display: inline-block;\n            margin-right: 6px; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_chart .chart_tagline p span {\n            color: #5856d6;\n            font-weight: bold; }\n          .programmer_tabs .tab-content #uncontrolled-tab-example-tabpane-overview .overview_chart_main .review_chart .chart_tagline p a {\n            text-decoration: underline; }\n\n.programmer_tabs .nav-tabs {\n  margin-top: -42px;\n  border-bottom: none; }\n\n.programmer_tabs .nav-tabs > li.active > a, .programmer_tabs .nav-tabs > li.active > a:focus, .programmer_tabs .nav-tabs > li.active > a:hover {\n  border: none;\n  border-bottom: 4px solid #5bd6e5;\n  opacity: 1;\n  background: transparent; }\n\n.programmer_tabs .nav-tabs > li > a {\n  border: 2px solid transparent;\n  border: none;\n  color: #313e59;\n  opacity: 0.65;\n  font-size: 14px;\n  padding: 12px 20px; }\n\n.programmer_tabs .nav-tabs > li > a > h4 {\n  font-size: 14px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid {\n  position: relative;\n  margin-bottom: 33px;\n  border-radius: 6px;\n  box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n  background-color: #ffffff;\n  min-height: 315px; }\n\n.programmer_tabs .tab-content #Overview {\n  padding: 50px 0px;\n  position: relative; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_heading h3 {\n  color: #5bd6e5;\n  font-family: Roboto;\n  font-size: 15px;\n  font-weight: 500;\n  text-transform: uppercase; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_heading {\n  padding: 20px;\n  border-bottom: 1px solid #dfe2e5; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content {\n  padding: 30px 24px;\n  position: relative; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content ul.over_uline li h5 {\n  font-family: Roboto;\n  font-size: 14px;\n  font-weight: normal;\n  color: #939da7;\n  line-height: 22px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content ul.over_uline li p {\n  font-family: Roboto;\n  font-size: 15px;\n  color: #313e59;\n  margin-bottom: 0;\n  word-break: break-all; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content ul.over_uline li {\n  margin-bottom: 25px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content ul.over_uline li:last-child {\n  margin-bottom: 0px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content ul.over_uline.over_uline_m25 li {\n  margin-bottom: 25px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content img.telelectronics_logo {\n  margin-bottom: 20px;\n  max-width: 140px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content ul.over_uline li h4 {\n  font-family: Roboto;\n  font-size: 14px;\n  color: #6f788b;\n  line-height: 20px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content .over_uline .regultion_arrow_content {\n  padding-left: 0.5em; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list {\n  padding-left: 10px;\n  border: 1px dotted #6f788b;\n  border-width: 0 0 2px 2px;\n  border-bottom: 15px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list p {\n  margin: 0;\n  background: white;\n  position: relative;\n  top: 8px;\n  padding-left: 5px;\n  line-height: 14px; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list p a {\n  color: #313e59; }\n\n.programmer_tabs .tab-content #Overview .overview_grid .overview_content .over_uline .regultion_arrow_content .contain-list ul {\n  border-left: 2px solid white;\n  margin-left: -12px;\n  border-top: 2px dotted #6f788b;\n  padding-left: 1.5em; }\n\n.programmer_tabs .tab-content #Overview .estimate_cost_div {\n  background-image: linear-gradient(to bottom, #4c5a78, #313e59);\n  border-radius: 6px;\n  box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n  height: 250px;\n  text-align: center;\n  padding: 45px 15px;\n  min-width: 270px; }\n\n.programmer_tabs .tab-content #Overview .estimate_cost_div h3 {\n  opacity: 0.7;\n  font-family: Roboto;\n  font-size: 15px;\n  font-weight: 500;\n  color: #fff;\n  text-transform: uppercase;\n  margin-bottom: 20px; }\n\n.programmer_tabs .tab-content #Overview .estimate_cost_div .price_cost {\n  font-family: Roboto;\n  font-size: 80px;\n  font-weight: 300;\n  color: #fff; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main {\n  width: 100%;\n  border-radius: 6px;\n  box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n  background-color: #ffffff;\n  height: 250px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_time_div {\n  background-image: linear-gradient(to bottom, #7472ea, #5856d6);\n  border-radius: 6px;\n  box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n  height: 250px;\n  text-align: center;\n  padding: 45px 15px;\n  min-width: 270px;\n  float: left;\n  width: 35%;\n  max-width: 270px;\n  border-top-right-radius: 0;\n  border-bottom-right-radius: 0; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_time_div h3 {\n  opacity: 0.7;\n  font-family: Roboto;\n  font-size: 15px;\n  font-weight: 500;\n  color: #fff;\n  text-transform: uppercase;\n  margin-bottom: 20px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_time_div .price_cost {\n  font-family: Roboto;\n  font-size: 80px;\n  font-weight: 300;\n  color: #fff;\n  line-height: 85px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_time_div p {\n  font-family: Roboto;\n  font-size: 20px;\n  color: #fff; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_chart {\n  float: left;\n  width: 68%;\n  padding: 30px;\n  height: 250px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_chart .chart_tagline {\n  border-radius: 16px;\n  background-color: rgba(201, 206, 211, 0.23);\n  position: relative;\n  padding: 10px 15px;\n  margin-bottom: 25px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_chart .chart_tagline p {\n  margin-bottom: 0;\n  color: #313e59;\n  font-size: 14px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_chart .chart_tagline span.fast_tag {\n  font-family: Roboto;\n  font-size: 11px;\n  font-weight: bold;\n  text-transform: uppercase;\n  border-radius: 7.5px;\n  background-color: #8bcc31;\n  color: #fff;\n  padding: 6px 10px;\n  line-height: 9px;\n  display: inline-block;\n  margin-right: 6px; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_chart .chart_tagline p span {\n  color: #5856d6;\n  font-weight: bold; }\n\n.programmer_tabs .tab-content #Overview .overview_chart_main .review_chart .chart_tagline p a {\n  text-decoration: underline; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div {\n  border-radius: 6px;\n  box-shadow: 0 1px 3px 0 rgba(38, 50, 77, 0.3);\n  background-color: #ffffff;\n  position: relative;\n  margin-top: 40px;\n  overflow: hidden; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_header {\n  padding: 20px;\n  border-bottom: 1px solid #dfe2e5; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_header h3 {\n  font-family: Roboto;\n  font-size: 16px;\n  font-weight: 500;\n  color: #26324d;\n  text-transform: uppercase; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_header .data_range span {\n  color: #939da7;\n  margin-right: 5px;\n  font-family: Roboto;\n  font-size: 14px;\n  font-weight: 500; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_header .data_range select {\n  background: transparent;\n  border: none;\n  font-weight: 500;\n  outline: none;\n  color: #4acad9;\n  font-size: 14px; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table {\n  margin-bottom: 0; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table tbody tr {\n  border-left: 5px solid transparent; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > tbody > tr > td, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > tbody > tr > th, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > tfoot > tr > td, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > tfoot > tr > th, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > thead > tr > td, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > thead > tr > th {\n  padding: 14px 15px;\n  border-top: 1px solid #ced4da; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > tbody > tr > td {\n  color: #26324d;\n  opacity: 0.8;\n  font-family: Roboto;\n  font-size: 14px;\n  font-weight: 500;\n  line-height: 20px; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > thead > tr > th {\n  color: #939da7;\n  font-family: Roboto;\n  font-size: 12px;\n  font-weight: 500;\n  text-transform: uppercase; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_content .table > thead > tr > th {\n  vertical-align: bottom;\n  border-bottom: none; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_chart {\n  padding: 30px; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_chart img {\n  width: 85%; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_pie_chart {\n  border-bottom: 1px solid #ced4da; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_pie_chart .in_pie_left, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_pie_chart .in_pie_right {\n  width: 50%;\n  float: left;\n  padding: 50px 80px;\n  text-align: center; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_pie_chart .in_pie_left {\n  border-right: 1px solid #dfe2e5; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_pie_chart .in_pie_left h4, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .incident_pie_chart .in_pie_right h4 {\n  line-height: 26px;\n  color: #5e6d7c;\n  margin-bottom: 48px;\n  font-family: Roboto;\n  font-size: 18px;\n  font-weight: normal; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs {\n  margin: 0;\n  margin-left: 15px; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li a img {\n  max-height: 20px;\n  width: auto;\n  opacity: 1; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs > li > a {\n  border: none;\n  opacity: 1;\n  font-size: 14px;\n  padding: 12px 5px; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .tab-content {\n  padding: 20px 30px; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li.active a img.bargraph, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li a img.piegraph_sel {\n  display: none; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li.active a img.piegraph_sel {\n  display: inline-block; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li.active a img.piegraph, .programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li a img.bargraph_sel {\n  display: none; }\n\n.programmer_tabs .tab-content #Incidents_Recalls .recalls_div .recalls_chart_div .nav-tabs li.active a img.bargraph_sel {\n  display: inline-block; }\n", ""]);
...
var profile_overview_1 = __importDefault(__webpack_require__(/*! ./profile-overview/profile-overview */ "./scripts/src/profile-overview/profile-overview.tsx"));
                ...
                react_1.default.createElement("div", { className: "container-fluid App" },
                    ...
                    react_1.default.createElement(ErrorBoundary_1.default, null,
                        ...
                        react_1.default.createElement(react_router_dom_1.Switch, null,
                            ...
                            react_1.default.createElement(react_router_dom_1.Route, { path: '/overview', component: profile_overview_1.default })),
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\avatar.png'");
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\foot-logo.png'");

/***/ }),

/***/ "./scripts/src/images/icon-save.png":
/*!******************************************!*\
  !*** ./scripts/src/images/icon-save.png ***!
  \******************************************/
/*! no static exports found */
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\icon-save.png'");

/***/ }),

/***/ "./scripts/src/images/icon-share.png":
/*!*******************************************!*\
  !*** ./scripts/src/images/icon-share.png ***!
  \*******************************************/
/*! no static exports found */
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\icon-share.png'");

/***/ }),

/***/ "./scripts/src/images/map_supply_chain.jpg":
/*!*************************************************!*\
  !*** ./scripts/src/images/map_supply_chain.jpg ***!
  \*************************************************/
/*! no static exports found */
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\map_supply_chain.jpg'");

/***/ }),

/***/ "./scripts/src/images/telelectronics_logo.png":
/*!****************************************************!*\
  !*** ./scripts/src/images/telelectronics_logo.png ***!
  \****************************************************/
/*! no static exports found */
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\telelectronics_logo.png'");
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\React\\anora-search\\scripts\\src\\images\\visa_icon.png'");
...
/***/ "./scripts/src/profile-overview/profile-overview.scss":
/*!************************************************************!*\
  !*** ./scripts/src/profile-overview/profile-overview.scss ***!
  \************************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/sass-loader/lib/loader.js!./profile-overview.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./scripts/src/profile-overview/profile-overview.scss");
...
/***/ "./scripts/src/profile-overview/profile-overview.tsx":
/*!***********************************************************!*\
  !*** ./scripts/src/profile-overview/profile-overview.tsx ***!
  \***********************************************************/
/*! no static exports found */
...
var react_1 = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
var react_bootstrap_1 = __webpack_require__(/*! react-bootstrap */ "./node_modules/react-bootstrap/es/index.js");
var react_d3_components_1 = __webpack_require__(/*! react-d3-components */ "./node_modules/react-d3-components/lib/index.js");
var d3_geo_1 = __webpack_require__(/*! d3-geo */ "./node_modules/d3-geo/src/index.js");
var topojson_client_1 = __webpack_require__(/*! topojson-client */ "./node_modules/topojson-client/index.js");
__webpack_require__(/*! ./profile-overview.scss */ "./scripts/src/profile-overview/profile-overview.scss");
var data = [
    {
        label: "SomethingA",
        values: [
...
var ProfileOverview = (function (_super) {
    __extends(ProfileOverview, _super);
    ...
    ProfileOverview.prototype.projection = function () {
        return d3_geo_1.geoMercator()
            .scale(100)
            .translate([800 / 2, 450 / 2]);
    };
    ProfileOverview.prototype.handleCountryClick = function (countryIndex) {
        console.log("Clicked on country: ", this.state.worlddata[countryIndex]);
    };
    ProfileOverview.prototype.handleMarkerClick = function (markerIndex) {
        console.log("Marker: ", this.state.cities[markerIndex]);
    };
    ProfileOverview.prototype.componentDidMount = function () {
        var _this = this;
        fetch("/world-110m.json")
            ...
            response.json().then(function (worlddata) {
                _this.setState({
                    worlddata: topojson_client_1.feature(worlddata, worlddata.objects.countries).features,
                });
            });
        });
    };
    ProfileOverview.prototype.render = function () {
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("section", { className: "programmer_pacemaker" },
                react_1.default.createElement("div", { className: "container" },
                    react_1.default.createElement("div", { className: "row" },
                        react_1.default.createElement("div", { className: "col-md-12" },
                            react_1.default.createElement("div", { className: "back_search" },
                                react_1.default.createElement("a", { href: "#" },
                                    react_1.default.createElement("i", { className: "fa fa-angle-left" }),
                                    " Back to Search Results")),
                            react_1.default.createElement("div", { className: "programmer_header" },
                                react_1.default.createElement("div", { className: "row" },
                                    react_1.default.createElement("div", { className: "col-md-6" },
                                        react_1.default.createElement("h2", null, "K871986  Model 5600B Programmer, Pacemaker")),
                                    react_1.default.createElement("div", { className: "col-md-6" },
                                        react_1.default.createElement("ul", { className: "list-inline text-right program_uline" },
                                            react_1.default.createElement("li", { className: "save_li" },
                                                react_1.default.createElement("a", { href: "#" },
                                                    react_1.default.createElement("img", { src: __webpack_require__(/*! ../images/icon-save.png */ "./scripts/src/images/icon-save.png") }),
                                                    " Save This")),
                                            react_1.default.createElement("li", { className: "share_li" },
                                                react_1.default.createElement("a", { href: "#" },
                                                    react_1.default.createElement("img", { src: __webpack_require__(/*! ../images/icon-share.png */ "./scripts/src/images/icon-share.png") }),
                                                    " Share")))))))))),
            react_1.default.createElement("section", { className: "programmer_tabs" },
                react_1.default.createElement("div", { className: "container" },
                    react_1.default.createElement(react_bootstrap_1.Tabs, { defaultActiveKey: "overview", id: "uncontrolled-tab-example" },
                        react_1.default.createElement(react_bootstrap_1.Tab, { eventKey: "overview", title: "Overview" },
                            react_1.default.createElement("div", { className: "row" },
                                react_1.default.createElement("div", { className: "col-md-3" },
                                    react_1.default.createElement("div", { className: "overview_grid" },
                                        react_1.default.createElement("div", { className: "overview_heading" },
                                            react_1.default.createElement("h3", null, "Applicant")),
                                        react_1.default.createElement("div", { className: "overview_content" },
                                            react_1.default.createElement("img", { className: "telelectronics_logo", src: __webpack_require__(/*! ../images/telelectronics_logo.png */ "./scripts/src/images/telelectronics_logo.png") }),
                                            react_1.default.createElement("ul", { className: "over_uline" },
                                                react_1.default.createElement("li", null,
                                                    react_1.default.createElement("h4", null,
                                                        ...
                                                        "suffield,  CT  06078")),
                                                react_1.default.createElement("li", null,
                                                    react_1.default.createElement("h5", null, "Applicant Contact"),
                                                    react_1.default.createElement("p", null, "William C Nealon")))))),
                                react_1.default.createElement("div", { className: "col-md-6" },
                                    react_1.default.createElement("div", { className: "overview_grid" },
                                        react_1.default.createElement("div", { className: "overview_heading" },
                                            react_1.default.createElement("h3", { style: { "color": "#ff9500" } }, "Application Details")),
                                        react_1.default.createElement("div", { className: "overview_content" },
                                            react_1.default.createElement("div", { className: "row" },
                                                react_1.default.createElement("div", { className: "col-md-6" },
                                                    react_1.default.createElement("ul", { className: "over_uline" },
                                                        react_1.default.createElement("li", null,
                                                            react_1.default.createElement("h5", null, "Regulation / Code"),
                                                            react_1.default.createElement("p", null, "870.3700 Pacemaker programmers"),
                                                            react_1.default.createElement("div", { className: "regultion_arrow_content" },
                                                                react_1.default.createElement("div", { className: "contain-list" },
                                                                    react_1.default.createElement("p", null,
                                                                        react_1.default.createElement("a", { href: "#" }, "KRG"),
                                                                        " "),
                                                                    react_1.default.createElement("ul", null)))),
                                                        react_1.default.createElement("li", null,
                                                            react_1.default.createElement("h5", null, "Classification"),
                                                            react_1.default.createElement("p", null, "Class III")),
                                                        react_1.default.createElement("li", null,
                                                            react_1.default.createElement("h5", null, "Clearance Type"),
                                                            react_1.default.createElement("p", null, "Traditional")))),
                                                react_1.default.createElement("div", { className: "col-md-6" },
                                                    react_1.default.createElement("div", { className: "row" },
                                                        react_1.default.createElement("div", { className: "col-md-6" },
                                                            react_1.default.createElement("ul", { className: "over_uline over_uline_m25" },
                                                                react_1.default.createElement("li", null,
                                                                    react_1.default.createElement("h5", null, "Submission Date"),
                                                                    react_1.default.createElement("p", null, "05-25-1987")))),
                                                        react_1.default.createElement("div", { className: "col-md-6" },
                                                            react_1.default.createElement("ul", { className: "over_uline over_uline_m25" },
                                                                react_1.default.createElement("li", null,
                                                                    react_1.default.createElement("h5", null, "Decision Date"),
                                                                    react_1.default.createElement("p", null, "06-24-1987"))))),
                                                    react_1.default.createElement("ul", { className: "over_uline" },
                                                        react_1.default.createElement("li", null,
                                                            react_1.default.createElement("h5", null, "Review Panel"),
                                                            react_1.default.createElement("p", null, "Cardiovascular")),
                                                        react_1.default.createElement("li", null,
                                                            react_1.default.createElement("h5", null, "Decision"),
                                                            react_1.default.createElement("p", null, "Substantially Equivalent (SESE)")))))))),
                                react_1.default.createElement("div", { className: "col-md-3" },
                                    react_1.default.createElement("div", { className: "overview_grid" },
                                        react_1.default.createElement("div", { className: "overview_heading" },
                                            react_1.default.createElement("h3", { style: { "color": "#8bcc31" } }, "FDA Contacts")),
                                        react_1.default.createElement("div", { className: "overview_content" },
                                            react_1.default.createElement("ul", { className: "over_uline" },
                                                react_1.default.createElement("li", null,
                                                    react_1.default.createElement("h5", null, "Division of cardiovascular devices"),
                                                    react_1.default.createElement("p", null,
                                                        "Bram D. Zuckerman, M.D.",
                                                        react_1.default.createElement("br", null),
                                                        "301-796-7000")),
                                                react_1.default.createElement("li", null,
                                                    react_1.default.createElement("h5", null, "Cardiac Electrophysiology Devices Branch"),
                                                    react_1.default.createElement("p", null,
                                                        "Mark Fellman",
                                                        react_1.default.createElement("br", null),
                            ...
                            react_1.default.createElement("div", { className: "row" },
                                react_1.default.createElement("div", { className: "col-md-3" },
                                    react_1.default.createElement("div", { className: "estimate_cost_div" },
                                        react_1.default.createElement("h3", null, "Estimated Cost"),
                                        react_1.default.createElement("div", { className: "price_cost" }, "$42k"))),
                                react_1.default.createElement("div", { className: "col-md-9" },
                                    react_1.default.createElement("div", { className: "overview_chart_main clearfix" },
                                        react_1.default.createElement("div", { className: "review_time_div" },
                                            react_1.default.createElement("h3", null, "Review Time"),
                                            react_1.default.createElement("div", { className: "price_cost" }, "29"),
                                            react_1.default.createElement("p", null, "days")),
                                        react_1.default.createElement("div", { className: "review_chart" },
                                            react_1.default.createElement("div", { className: "chart_tagline" },
                                                react_1.default.createElement("p", null,
                                                    react_1.default.createElement("span", { className: "fast_tag" }, "Fast"),
                                                    " Faster than ",
                                                    react_1.default.createElement("span", null, "57"),
                                                    " of ",
                                                    react_1.default.createElement("span", null, "58"),
                                                    " applications under product code ",
                                                    react_1.default.createElement("a", { href: "#" }, "KRG"))),
                                            react_1.default.createElement(react_d3_components_1.BarChart, { data: data, width: 500, height: 200, tooltipHtml: tooltipScatter, shapeColor: "red", margin: { top: 10, bottom: 50, left: 50, right: 10 } })))))),
                        react_1.default.createElement(react_bootstrap_1.Tab, { eventKey: "explorer", title: "Anora Explorer\u00AE" }, "Anora Explorer\u00AE"),
                        react_1.default.createElement(react_bootstrap_1.Tab, { eventKey: "supply-chain", title: "Supply Chain" },
                            react_1.default.createElement("img", { src: __webpack_require__(/*! ../images/map_supply_chain.jpg */ "./scripts/src/images/map_supply_chain.jpg") })),
                        react_1.default.createElement(react_bootstrap_1.Tab, { eventKey: "incidents", title: "Incidents & Recalls" },
                            react_1.default.createElement("div", { className: "row" },
                                react_1.default.createElement("div", { className: "col-md-12" },
                                    react_1.default.createElement("div", { className: "recalls_div" },
                                        react_1.default.createElement("div", { className: "clearfix recalls_header" },
                                            react_1.default.createElement("h3", { className: "pull-left" }, "Recalls"),
                                            react_1.default.createElement("div", { className: "pull-right data_range" },
                                                react_1.default.createElement("span", null, "Data Range:"),
                                                react_1.default.createElement("select", null,
                                                    react_1.default.createElement("option", null, "Last 5 years"),
                                                    react_1.default.createElement("option", null, "Last 10 years"),
                                                    react_1.default.createElement("option", null, "Last 11 years")))),
                                        react_1.default.createElement("div", { className: "recalls_chart_div" },
                                            react_1.default.createElement("ul", { className: "nav nav-tabs", role: "tablist" },
                                                react_1.default.createElement("li", { className: "active" },
                                                    react_1.default.createElement("a", { href: "#recalls_bar_chart", role: "tab", "data-toggle": "tab", "aria-expanded": "false" },
                                                        react_1.default.createElement("img", { className: "bargraph_sel", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/icon-bargraph-selected.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }),
                                                        react_1.default.createElement("img", { className: "bargraph", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/icon-bargraph.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }))),
                                                react_1.default.createElement("li", { className: "" },
                                                    react_1.default.createElement("a", { href: "#recalls_pie_chart", role: "tab", "data-toggle": "tab", "aria-expanded": "true" },
                                                        react_1.default.createElement("img", { className: "piegraph_sel", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/icon-piegraph-selected.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }),
                                                        react_1.default.createElement("img", { className: "piegraph", src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/icon-piegraph.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) })))),
                                            react_1.default.createElement("div", { className: "tab-content" },
                                                react_1.default.createElement("div", { className: "tab-pane active", id: "recalls_bar_chart" },
                                                    react_1.default.createElement("img", { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/recalls_bar_chart.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) })),
                                                react_1.default.createElement("div", { className: "tab-pane", id: "recalls_pie_chart" },
                                                    react_1.default.createElement("img", { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/recalls_pie_chart.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) })))),
                                        react_1.default.createElement("div", { className: "recalls_content" },
                                                ...
                                                react_1.default.createElement("table", { className: "table" },
                                                    react_1.default.createElement("thead", null,
                                                        react_1.default.createElement("tr", null,
                                                            ...
                                                            react_1.default.createElement("th", { style: { "width": "12%", "textAlign": "center" } }, "Recall Class"),
                                                            react_1.default.createElement("th", { style: { "width": "12%;" } }, "Root Cause"),
                                                            react_1.default.createElement("th", null, "Reason"))),
                                                    react_1.default.createElement("tbody", null,
                                                        react_1.default.createElement("tr", { style: { "borderColor": "#9adf55" } },
                                                            react_1.default.createElement("td", null, "9/12/2017"),
                                                            react_1.default.createElement("td", { style: { "textAlign": "center" } }, "2"),
                                                            react_1.default.createElement("td", null, "Device Design"),
                                                            react_1.default.createElement("td", { style: { "opacity": "0.6" } },
                                                                "Boston Scientific has received reports of intermittent over-sensing of the Minute Ventilation (MV) sensor signal with certain Boston Scientific pacemaker and cardiac resynchronization\u2026 ",
                                                                react_1.default.createElement("a", { href: "#", style: { "color": "#44c0d0", "fontWeight": "400" } }, "More"))),
                                                        react_1.default.createElement("tr", { style: { "borderColor": "#6eb4ff" } },
                                                            react_1.default.createElement("td", null, "10/6/2015"),
                                                            react_1.default.createElement("td", { style: { "textAlign": "center" } }, "2"),
                                                            react_1.default.createElement("td", null, "Packaging"),
                                                            react_1.default.createElement("td", { style: { "opacity": "0.6" } }, "The use of Allura Xper, Allura Clarity, Allura CV, Allura Centron and UNIQ systems regarding live images and still images can lead to still images being interpreted as live Images.")),
                                                        react_1.default.createElement("tr", { style: { "borderColor": "#007aff" } },
                                                            react_1.default.createElement("td", null, "9/22/2015"),
                                                            react_1.default.createElement("td", { style: { "textAlign": "center" } }, "2"),
                                                            react_1.default.createElement("td", null, "Packaging Process Control"),
                                                            react_1.default.createElement("td", { style: { "opacity": "0.6" } },
                                                                "Extra monitors, so called 7th or 8th monitor, mounted on the Monitor Ceiling Suspension (MCS), might disengage from the MCS and fall down. The two small set screws securing the two\u2026 ",
                                                                react_1.default.createElement("a", { href: "#", style: { "color": "#44c0d0", "fontWeight": "400" } }, "More")))))))),
                                    react_1.default.createElement("div", { className: "recalls_div incidents_div" },
                                        react_1.default.createElement("div", { className: "clearfix recalls_header" },
                                            react_1.default.createElement("h3", { className: "pull-left" }, "INCIDENTS"),
                                            react_1.default.createElement("div", { className: "pull-right data_range" },
                                                react_1.default.createElement("span", null, "Data Range:"),
                                                react_1.default.createElement("select", null,
                                                    react_1.default.createElement("option", null, "Last 5 years"),
                                                    react_1.default.createElement("option", null, "Last 10 years"),
                                                    react_1.default.createElement("option", null, "Last 11 years")))),
                                        react_1.default.createElement("div", { className: "incident_pie_chart clearfix" },
                                            react_1.default.createElement("div", { className: "in_pie_left" },
                                                react_1.default.createElement("h4", null, "Who was operating the device at time of the event?"),
                                                react_1.default.createElement("img", { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/operating_device.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) })),
                                            react_1.default.createElement("div", { className: "in_pie_right" },
                                                react_1.default.createElement("h4", null, "Was an adverse patient outcome involved?"),
                                                react_1.default.createElement("img", { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/adverse_outcome.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }))),
                                        react_1.default.createElement("div", { className: "incident_chart" },
                                            react_1.default.createElement("img", { src: "img/c1.png" }),
                                            react_1.default.createElement("div", { className: "recalls_content" },
                                                react_1.default.createElement("div", { className: "table-responsive" },
                                                    react_1.default.createElement("table", { className: "table" },
                                                        react_1.default.createElement("thead", null,
                                                            react_1.default.createElement("tr", null,
                                                                react_1.default.createElement("th", { style: { "width": "12%" } },
                                                                    "Event Date ",
                                                                    react_1.default.createElement("i", { className: "fa fa-angle-down" })),
                                                                react_1.default.createElement("th", { style: "width:12%; text-align: center;" }, "Type"),
                                                                react_1.default.createElement("th", { style: { "width": "12%", "textAlign": "center" } }, "Device Problems"),
                                                                react_1.default.createElement("th", null, "Description"))),
                                                        react_1.default.createElement("tbody", null,
                                                            react_1.default.createElement("tr", { style: { "borderColor": "#5856d6" } },
                                                                react_1.default.createElement("td", null, "9/12/2018"),
                                                                react_1.default.createElement("td", { style: { "textAlign": "center" } }, "Malfunction"),
                                                                react_1.default.createElement("td", null, "Fracture; High impedance; High Capture Threshold"),
                                                                react_1.default.createElement("td", { style: { "opacity": "0.6" } },
                                                                    "It was reported that high thresholds and high impedance were noted on the right ventricular (rv) lead. There was a suspected lead fracture. The lead was explanted and replaced. No\u2026 ",
                                                                    react_1.default.createElement("a", { href: "#", style: { "color": "#44c0d0", "fontWeight": "400" } }, "More"))),
                                                            react_1.default.createElement("tr", { style: "border-color: #5856d6;" },
                                                                react_1.default.createElement("td", null, "10/6/2017"),
                                                                react_1.default.createElement("td", { style: "text-align: center;" }, "Malfunction"),
                                                                react_1.default.createElement("td", null, "Intermittent Capture; Under-Sensing ; Decreased Sensitivity"),
                                                                react_1.default.createElement("td", { style: "opacity: 0.6;" },
                                                                    "It was reported that there was an under-sensed premature ventricular contraction (pvc) noted on the presenting electrograms (egm). It was also reported there were small r waves me\u2026 ",
                                                                    react_1.default.createElement("a", { href: "#", style: { "color": "#44c0d0", "fontWeight": "400" } }, "More"))),
                                                            react_1.default.createElement("tr", { style: { "borderColor": "#ff9500" } },
                                                                react_1.default.createElement("td", null, "9/22/2016"),
                                                                react_1.default.createElement("td", { style: { "textAlign": "center" } }, "Injury"),
                                                                react_1.default.createElement("td", null, "High Capture Threshold"),
                                                                react_1.default.createElement("td", { style: { "opacity": "0.6" } },
                                                                    "It was reported that high thresholds were noted on the right atrial (ra) and right ventricular (rv) leads. Both leads were removed and replaced with a leadless implantable pulse gene\u2026 ",
                                                                    react_1.default.createElement("a", { href: "#", style: { "color": "#44c0d0", "fontWeight": "400" } }, "More"))))))))))))))),
...
/******/ });
//# sourceMappingURL=app.0e7d4e4ff940e049bb52.js.map