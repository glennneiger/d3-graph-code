...
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../jsonMap\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var data = [
    {
        label: "SomethingA",
        values: [
                ...
                react_1.default.createElement("div", { className: "container" },
                    react_1.default.createElement(react_bootstrap_1.Tabs, { defaultActiveKey: "overview", id: "uncontrolled-tab-example" },
                        ...
                        react_1.default.createElement(react_bootstrap_1.Tab, { eventKey: "supply-chain", title: "Supply Chain" },
                            react_1.default.createElement("svg", { width: 800, height: 450, viewBox: "0 0 800 450" },
                                react_1.default.createElement("g", { className: "countries" }, this.state.worlddata.map(function (d, i) { return (react_1.default.createElement("path", { key: "path-" + i, d: d3_geo_1.geoPath().projection(_this.projection())(d), className: "country", fill: "rgba(38,50,56," + 1 / _this.state.worlddata.length * i + ")", stroke: "#FFFFFF", strokeWidth: 0.5, onClick: function () { return _this.handleCountryClick(i); } })); })),
                                react_1.default.createElement("g", { className: "markers" }, this.state.cities.map(function (city, i) { return (react_1.default.createElement("circle", { key: "marker-" + i, cx: _this.projection()(city.coordinates)[0], cy: _this.projection()(city.coordinates)[1], r: city.population / 3000000, fill: "#E91E63", stroke: "#FFFFFF", className: "marker", onClick: function () { return _this.handleMarkerClick(i); } })); })))),
...
/******/ });
//# sourceMappingURL=app.3320c7a5a48955f9fff2.js.map